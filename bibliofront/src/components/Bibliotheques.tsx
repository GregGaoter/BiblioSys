          ...
          <CardDeck>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Cette bibliothèque située <strong>10 Rue des Bijoux</strong> vous fera rêver avec sa large collection
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Cette bibliothèque située <strong>49 Rue de Lavande</strong> ne vous laissera pas à court d'idée avec
                  sa large collection de revues techniques et de bricolage.
                </Card.Text>
              </Card.Body>
              <Card.Footer>
                <small className="text-muted">500 livres</small>
